<div>
    ...
    <div class="table-responsive">
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr class="px-0 mx-0">
                    <td>{{$loop->index +1}}</td>
                    <td class="text-center">{{cutLongText($direction->libelle)}}</td>
                    <td class="text-end">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu bg-transparent">
                                <div class="text-end">
                                    <a href="/direction/{{$direction->id}}/update" class="action-button bg-warning">Modifier</a> <br>
                                    <a href="/direction/{{$direction->id}}/delete" class="action-button bg-red text-white">Supprimer</a>
                                </div>
                            </ul>
                        </div>
                    </td>
    ...
    @endif
    @else
    <h3 class="text-center text-green mt-2">Aucune direction ajoutée!</h3>
    @endif
    @endif
</div>